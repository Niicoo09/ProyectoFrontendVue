 ...
 */  {
  ...
  { name: 'e2_tensionMaxima', label: 'TENSIÓN MÁXIMA (V)', placeholder: 'Opcional', type: 'text', subsection: 'E2', group: 'Bateria' },
  { name: 'e2_tensionMinima', label: 'TENSIÓN MÍNIMA (V)', placeholder: 'Opcional', type: 'text', subsection: 'E2', group: 'Bateria' },
  { name: 'e2_energiaTotal', label: 'ENERGÍA TOTAL ', placeholder: 'Opcional', type: 'text', subsection: 'E2', group: 'Bateria' },
  { name: 'e2_potenciaMaximaSalida', label: 'POTENCIA MÁXIMA SALIDA', placeholder: 'Opcional', type: 'text', subsection: 'E2', group: 'Bateria' },
  { name: 'e2_maximoPicoDePotencia', label: 'MÁXIMO PICO DE POTENCIA', placeholder: 'Opcional', type: 'text', subsection: 'E2', group: 'Bateria' },
 ...
 */
  ...
  */
  ...
  { name: 'telefonoRepresentanteEntidad', label: 'Teléfono del Representante de la Entidad', placeholder: 'Ej: 600123456', type: 'text', subsection: 'LEGALIZACION', group: 'anexo III' },
  { name: 'correoElectronicoRepresentanteEntidad', label: 'Correo Electrónico del Representante de la Entidad', placeholder: 'Ej: correo@ejemplo.com', type: 'text', subsection: 'LEGALIZACION', group: 'anexo III' },
  ...
  { 
    name: 'ext_tipoInstalacion', 
    label: 'Tipo de Instalación (Extremadura)', 
    type: 'select', 
    options: ['Generación Fotovoltaica Interconectada', 'Generación Fotovoltaica Aislada'], 
    value: 'Generación Fotovoltaica Interconectada', 
    subsection: 'EXTREMADURA', 
    group: 'Modalidad de Autoconsumo',
    mapFrom: 'tipoInstalacion',
    mapTransform: {
      'Fotovoltaica conectada a red interior': 'Generación Fotovoltaica Interconectada',
      'Fotovoltaica aislada': 'Generación Fotovoltaica Aislada'
    }
  },
  { 
    ...
    type: 'select', 
    options: [
      { label: 'Tipo 1 (sin excedentes)', value: 'Tipo 1' },
      { label: 'Tipo 2 (con excedentes)', value: 'Tipo 2' }
    ], 
    value: 'Tipo 2', 
    subsection: 'EXTREMADURA', 
    group: 'Modalidad de Autoconsumo' 
  ...
  { name: 'sistemaInstalacionDI', label: 'Sistema de instalación', placeholder: 'Ej: Bajo tubo', type: 'text', subsection: 'EXTREMADURA', group: 'Derivación Individual:', mapFrom: 'sistemaInstalacionDI' },
  { name: 'conductorDI', label: 'Conductor', placeholder: 'Ej: Cobre', type: 'text', subsection: 'EXTREMADURA', group: 'Derivación Individual:', mapFrom: 'conductorDI' },
  ...
  { name: 'nifDirector', label: 'NIF Director de Obra', placeholder: 'Ej: 12345678A', type: 'text', subsection: 'EXTREMADURA', group: 'Instalador y Director', showIf: { field: 'llevaProyecto', value: true } },
  ...
  { name: 'l3l4', label: 'Línea de Subvención', type: 'select', options: ['Línea 3', 'Línea 4'], placeholder: 'ej: Línea 3', subsection: 'JUSTIFICACION' },
  {
    name: 'parrafoTexto', label: 'Párrafo Introducción', type: 'select', options: [
      { label: 'Edificio (Línea 3)', value: 'Estas ayudas tienen por objeto la financiación de obras o actuaciones en los edificios de uso predominante residencial en las que se obtenga una mejora acreditada de la eficiencia energética, con especial atención a la envolvente edificatoria en edificios de tipología residencial colectiva, incluyendo sus viviendas, y en las viviendas unifamiliares.' },
      { label: 'Vivienda (Línea 4)', value: 'Estas ayudas tienen por objeto la financiación de actuaciones u obras de mejora de la eficiencia energética en las viviendas, ya sean unifamiliares o pertenecientes a edificios plurifamiliares' }
  ...
  { name: 'tipoEdificioFvAerotermia', label: 'Tipo de Edificio', type: 'select', options: [{ label: 'Edificio (Línea 3)', value: 'EDIFICIO DE VIVIENDA UNIFAMILIAR' }, { label: 'Vivienda (Línea 4)', value: 'VIVIENDAS' }], placeholder: 'ej: Edificio', subsection: 'JUSTIFICACION', group: 'Memoria FV+Aer' },
  { name: 'textoOpcional1', label: 'Texto Opcional 1', placeholder: 'Ej: Texto opcional', type: 'select', options: [{ label: 'Edificio (Línea 3)', value: 'Estas ayudas tienen por objeto la financiación de actuaciones u obras de mejora de la eficiencia energética en edificios, en concreto en una vivienda unifamiliar no perteneciente a un bloque de viviendas ' }, { label: 'Vivienda (Línea 4)', value: 'Estas ayudas tienen por objeto la financiación de actuaciones u obras de mejora de la eficiencia energética en las viviendas, ya sean unifamiliares o pertenecientes a edificios plurifamiliares' }], fullWidth: true, subsection: 'JUSTIFICACION', group: 'Memoria FV+Aer' },
  ...
  { name: 'rep_leg_sexo', label: 'Sexo (R.Leg.)', type: 'select', subsection: 'PRESENTACIÓN', group: 'Representante Legal (Robot)', value: 'M', options: [{ value: 'M', label: 'Hombre/Masculino' }, { value: 'F', label: 'Mujer/Femenino' }] },
  ...
  { name: 'uso_instalacion', label: 'Uso de la instalación', type: 'text', subsection: 'PRESENTACIÓN', group: 'Instalación (Robot)', value: 'produccion de energia electrica' },
  {
